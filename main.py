...
from fluentflet.components import (
    ...
    Radio, RadioGroup,
    TreeView, DictTreeViewModel, JSONTreeViewModel,
    TextBox,
    ToolTip,
    Calendar,
    Toggle, 
...
def main(page: ft.Page):
    ...
    window = FluentWindow(
        ...
        navigation_items=[
            ...
            {"icon": FluentIcons.CHECKBOX_CHECKED, "label": "Checkbox", "route": "/components/checkbox"},
            {"icon": FluentIcons.RADIO_BUTTON, "label": "Radio", "route": "/components/radio"},
            {"icon": FluentIcons.TOGGLE_LEFT, "label": "Toggle", "route": "/components/toggle"},
            {"icon": FluentIcons.TEXT_FIELD, "label": "TextBox", "route": "/components/textbox"},
            {"icon": FluentIcons.COMMENT, "label": "Dropdown", "route": "/components/dropdown"},
            {"icon": FluentIcons.ARROW_AUTOFIT_WIDTH, "label": "Slider", "route": "/components/slider"},
            {"icon": FluentIcons.CALENDAR_EMPTY, "label": "Calendar", "route": "/components/calendar"},
            {"icon": FluentIcons.LIST, "label": "ListItem", "route": "/components/listitem"},
            {"icon": FluentIcons.CHEVRON_DOWN, "label": "Expander", "route": "/components/expander"},
            {"icon": FluentIcons.ARROW_SYNC_CIRCLE, "label": "Progress", "route": "/components/progress"},
            {"icon": FluentIcons.TEXT_BULLET_LIST_TREE, "label": "Treeview", "route": "/components/treeview"},
            {"icon": FluentIcons.RECTANGLE_LANDSCAPE, "label": "Dialog", "route": "/components/dialog"}
        ],
    ...
    @window.route("/")
    def home():
        return DisplayGroup(title="home", widgets=[
            DisplayItem(
    ...
    def slider():
        return DisplayGroup(title="Slider", widgets=[
            DisplayItem(
    ...
    def button():
        return DisplayGroup(title="Button", widgets=[
            DisplayItem(
    ...
    def checkbox():
        return DisplayGroup(title="Checkbox", widgets=[
            DisplayItem(
    ...
    def radio():
        return DisplayGroup(title="Radio", widgets=[
            DisplayItem(
                title="Radio Group",
                content=RadioGroup(
                    content=ft.Column([
    ...
    def toggle():
        return DisplayGroup(title="Toggle", widgets=[
            DisplayItem(
    ...
    def textbox():
        return DisplayGroup(title="TextBox", widgets=[
            DisplayItem(
                title="Standard TextBox",
                content = textbox_test
            ),
            DisplayItem(
    ...
    def dropdown():
        return DisplayGroup(title="Dropdown", widgets=[
            DisplayItem(
    ...
    def calendar():
        return DisplayGroup(title="Calendar", widgets=[
            DisplayItem(
    ...
    def listitem():
        return DisplayGroup(title="List Item",widgets=[
            DisplayItem(
    ...
    def expander():
        return DisplayGroup(title="Expander", widgets=[
            DisplayItem(
    ...
    def treeview():
        return DisplayGroup(title="Treeview", widgets=[
            DisplayItem(
    ...
    def progress():
        ...
        return DisplayGroup(title="Progress Ring", widgets=[
            DisplayItem(
                title = "Indeterminate progress ring",
                content = ProgressRing()
            ),
            DisplayItem(
                title = "Determiante progress ring",
                content = create_progress_view()
            )
        ])
    ...
    def dialog():
        ...
        return DisplayGroup(title="Dialog", widgets=[
            DisplayItem(
                title="Basic Dialog",
